...
class TestDensityDataLoader(unittest.TestCase):
    ...
    def test_density_data_loading(self):
        ...
        self.assertEqual(loaded_data["density"].shape, (100, 10)) # 100 frames, 10x1x1 grid
    ...
    def test_grid_generation(self):
        ...
        self.assertEqual(loaded_data["grid"].shape, (100, 10, 3)) # 100 frames, 10x1x1 grid, 3 dim
    ...
    def test_density_data_shape(self):
        ...
        # Get a batch of data
        batch_data = data.get_batch(10)

        # Check if density data has the correct shape in the batch
        self.assertIn("density", batch_data)
        self.assertEqual(batch_data["density"].shape, (10, 1))  # 10 frame, 1x1x1 grid
    ...
    def test_grid_data_shape(self):
        ...
        self.assertEqual(batch_data["grid"].shape, (10, 1, 3)) # 10 frame, 1x1x1 grid, 3 dim
