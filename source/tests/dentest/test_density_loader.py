...
class TestDensityDataLoader(unittest.TestCase):
    ...
    def test_density_data_loading(self):
        ...
        self.assertEqual(loaded_data["density"].shape, (1, 10)) # 100 frames, 10x1x1 grid
    ...
    def test_grid_generation(self):
        ...
        self.assertEqual(loaded_data["grid"].shape, (1, 10, 3)) # 100 frames, 10x1x1 grid, 3 dim
    ...
    def test_density_data_shape(self):
        ...
        self.assertEqual(batch_data["density"].shape, (1, 1))  # 10 frame, 1x1x1 grid
    ...
    def test_grid_data_shape(self):
        ...
        self.assertEqual(batch_data["grid"].shape, (1, 1, 3)) # 10 frame, 1x1x1 grid, 3 dim
